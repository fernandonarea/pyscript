...
try:
    ...
    time.sleep(3)
    select_carrera = Select(
        driver.find_element(By.NAME, "ctl00$MainContent$DDL_CARRERA")
    )
    ...
    select_periodo = Select(
        driver.find_element(By.NAME, "ctl00$MainContent$DDL_PLECTIVO")
    )
